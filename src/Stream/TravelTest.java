...
public class TravelTest {
	...
	public static void main(String[] args) {
		...
		//이미 정렬이 되어있는데 하나 더 정렬을 하고 싶을 수가 있잖아 그럴  때 사용하는 것이 컴패어투 함수야 
	}
